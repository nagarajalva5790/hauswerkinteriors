      ...
      <section className='bg-neutral-900 text-white py-24 text-center'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <p className='text-neutral-400 text-lg max-w-2xl mx-auto'>
            From modern home interior concepts to technical maintenance, HausWerk is your single point of contact for everything
            home.
          </p>
        </div>
      </section>
                ...
                >
                  ...
                  <div className='md:w-1/2'>
                    ...
                    <p className='text-neutral-600 text-lg leading-relaxed mb-8'>
                      {service.description} Our expertise ensures that every modular kitchen or home interior project is handled
                      with technical precision and aesthetic care. We follow a strict execution timeline for all our plumbing
                    ...
                    <div className='flex flex-wrap gap-3 mb-10'>
                      {['Quality Tested', 'Professional execution', 'Transparent pricing'].map((tag, i) => (
                        <span
                          key={i}
                          className='text-xs font-bold uppercase tracking-widest text-neutral-400 bg-neutral-100 px-3 py-1 rounded'
                        >
                          {tag}
                        </span>
                      ))}
                    ...
                    <Link
                      to='/contact'
                      className='inline-block bg-neutral-900 text-white px-8 py-3 rounded-md font-bold hover:bg-neutral-800 transition-colors'
                    >
      ...
      <section className='bg-amber-50 py-24'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-neutral-600 max-w-3xl mx-auto mb-12 text-lg'>
            A beautiful home stays functional through professional care. We offer specialized plumbing services and certified
            electrical services to keep your residence safe.
          </p>
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='bg-white p-8 rounded-xl shadow-sm'>
              <h4 className='font-bold text-lg mb-4 font-serif'>Emergency Support</h4>
              <p className='text-sm text-neutral-500'>
                Quick response for critical plumbing services or electrical issues in your apartment.
              </p>
            </div>
            <div className='bg-white p-8 rounded-xl shadow-sm'>
              <h4 className='font-bold text-lg mb-4 font-serif'>Renovation Consulting</h4>
              <p className='text-sm text-neutral-500'>Expert advice on modular kitchen modifications and structural works.</p>
            </div>
            <div className='bg-white p-8 rounded-xl shadow-sm'>
              <h4 className='font-bold text-lg mb-4 font-serif'>Quality Audits</h4>
              <p className='text-sm text-neutral-500'>
                Regular checkups for painting, polishing, and home interior quality standards.
              </p>
            </div>
          </div>
        </div>
