      ...
      <section className='bg-neutral-50 py-24 border-b border-neutral-100'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl text-neutral-600 max-w-2xl mx-auto leading-relaxed'>
            Take a look at some of our recent home interior transformations. Each project reflects our commitment to functional
            and timeless design.
          </p>
        </div>
      </section>
            ...
            {categories.map((cat) => (
              <button
                ...
                className={`px-6 py-2 rounded-full text-sm font-bold tracking-widest uppercase transition-all ${
                  filter === cat ? 'bg-amber-600 text-white shadow-lg' : 'bg-neutral-100 text-neutral-500 hover:bg-neutral-200'
                }`}
              >
                {cat}
              </button>
