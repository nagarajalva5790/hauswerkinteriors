...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt: "From biophilic elements to 'quiet luxury', discover what's shaping modern home interior Bangalore trends this year.",
  ...
  },
  {
    ...
    date: "April 15, 2024",
    category: "Materials",
    excerpt: "A comparison of BWP Plywood vs. MDF for your modular kitchen Bangalore project and best finishes for Indian cooking.",
...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    description: "Designer ceilings integrated with sophisticated lighting for the perfect ambiance in your Bangalore residence.",
    icon: "Layers",
...
export const ICON_MAP: Record<string, React.ElementType> = {
  Home, ChefHat, DoorOpen, Layers, Droplet, Zap, Paintbrush, Hammer,
  ShieldCheck, Clock, CircleDollarSign, UserCheck, TrendingUp, BookOpen,
  Image: ImageIcon
};
...
export const REASONS = [
  {
    ...
    description: "We manage every vendor and detail, so you only talk to one professional for your home interior Bangalore project.",
    icon: "UserCheck"
  },
  {
